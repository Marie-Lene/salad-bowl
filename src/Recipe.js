        ...
        <section className="recipe-aside">
            <div>
                <div className="header">
                    ...
                    <p>
                        ...
                        <input
                            onChange={(event) =>
                                calculateUnit(event.target.value)
                            }
                            id="portions"
                            type="number"
                            min="1"
            ...
            <ul className="ingredient-list">
                <li className="ingredient-item">
                    <div className="unit">
                        {ingredients.base.serving * unit}{" "}
                        {ingredients.base.unit}
                    </div>
                    <div className="ingredient">{ingredients.base.name_en}</div>
                </li>
                <li className="recipe-aside ingredient-item">
                    <div className="unit">
                        {ingredients.greens.serving * unit}{" "}
                        {ingredients.greens.unit}
                    </div>
                    <div className="ingredient">
                        {ingredients.greens.name_en}
                    </div>
                </li>
                <li className="recipe-aside ingredient-item">
                    <div className="unit">
                        {ingredients.veggies.serving * unit}{" "}
                        {ingredients.veggies.unit}
                    </div>
                    <div className="ingredient">
                        {ingredients.veggies.name_en}
                    </div>
                </li>
                <li className="recipe-aside ingredient-item">
                    <div className="unit">
                        {ingredients.extra.serving * unit}{" "}
                        {ingredients.extra.unit}
                    </div>
                    <div className="ingredient">
                        {ingredients.extra.name_en}
                    </div>
                </li>
                <li className="recipe-aside ingredient-item">
                    <div className="unit">
                        {ingredients.dressing.serving * unit}{" "}
                        {ingredients.dressing.unit}
                    </div>
                    <div className="ingredient">
